...
durations_df = pd.DataFrame(data=movie_dict)
...
#durations_df.plot(x="years", y="durations")
...
are_movies_getting_shorter = "To some extent, some of the movie durations are shorter"
